...
//publishTestResult type:'unit', fileLocation: '/var/jenkins_home/workspace/Jenkins-Github/simpleTest.json'
                    publishTestResult type:'unit', fileLocation: './mochatest.json', serviceName: "UnitTestService", hostName: "local-dash.gravitant.net", resultType: "mocha", id: "${ID}"
                    publishTestResult type:'codecoverage', fileLocation: './tests/coverage/reports/coverage-summary.json', serviceName: "IstanbulCovService", hostName: "local-dash.gravitant.net", resultType: "istanbul", id: "${ID}"
                    publishTestResult type:'function', fileLocation: './mochafvt.json', serviceName: "FunctionService", hostName: "local-dash.gravitant.net", resultType: "mocha", id: "${ID}"
